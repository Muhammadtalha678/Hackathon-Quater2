...
const TopHeader = () => {
  return (
    <div className='h-11 px-4 md:px-8 lg:px-12 xl:px-36 bg-[#272343] flex items-center justify-between'>
        <div className="flex gap-2 items-center">
            <FaCheck size={13} color='#FFFFFF'/>
            <ThemeText fontWeight='font-normal' className='text-[#FFFFFF] leading-3 text-[8px] mxs:text-[10px] xs:text-[13px]'>Free shipping on all orders over $50</ThemeText>
        </div>
